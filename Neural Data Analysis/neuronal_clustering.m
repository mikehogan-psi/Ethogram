...
load('Z:\Abi\neuronal_data\mouse_2\Mike processed data\extinction_poisson_ONLYfreezing_FLASHvsLOOM_signif_neurons.mat')
...
features_only_during = features_only_clean(:, 1);
features_only_post   = features_only_clean(:, 2);
...
save('Z:\Abi\neuronal_data\mouse_2\Mike processed data\extinction_poisson_ONLYfreezing_clustering', 'neuron_cluster_assignments');
...
feature_labels = ["Freezing (Stim)", "Freezing (Post)"];
...
%% Plotting Mean Firing Rate across Trials by Cluster 
...
%% Plotting Mean Firing Rate across Time Bins by Cluster
