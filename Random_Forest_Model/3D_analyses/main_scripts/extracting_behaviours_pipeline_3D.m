...
% 2. Define directories to where specific data can be accessed/saved 
     ...
     % B: folder where data labeled with desired behaviour shall be saved   
            % common_behav_dir = 'C:\Abi_Hogan\behavioral_analysis\extinction_analysis\rearing_data\';  % Stopford PC
              common_behav_dir = 'C:\Users\Abi Hogan\Documents\Psychedelics_Internship\behavior_analysis\pre_aquisistion_3D_analysis'; % Laptop
...
SSM_est_mike_abi(triangulated_data_path, SSM_model_name_path)
...
% SSM_3D_headNOTfitted_good_frames.mat (body): results of PCA  (the tree main eigenposes that together explain 80% of the data variation from mean pose)
                    % Eigenpose 1: "bending side to side" of body
                    % Eigenpose 2: "elongation/hunching" of body 
                    % Eigenpose 3: "up/down movement" of head with bending body in opposite direction
