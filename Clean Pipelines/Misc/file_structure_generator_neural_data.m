...
% root_dir = 'W:\Mike\Neuropixels_Fear_Conditioning\Data';
...
mice = {'Mouse 1', 'Mouse 2', 'Mouse 3', 'Mouse 4', 'Mouse 5', 'Mouse 6',...
    'Mouse 7', 'Mouse 8', 'Mouse 9', 'Mouse 10', 'Mouse 11', 'Mouse 12'}; % Add mice as needed
...
processed_unprocessed_n = {'Raw Data', 'Concatenated Data', 'Triggers', 'Cell Depths'};
