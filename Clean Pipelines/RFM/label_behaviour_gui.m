...
set(fig,'DefaultUIControlFontWeight','bold','DefaultAxesFontWeight','bold','DefaultTextFontWeight','bold');
...
super_title.FontSize = 20;      % pick size you like
super_title.FontWeight = 'bold';
