function[] = Fit_SSM_3D_habituation(current_3Ddata_file, SSM_data_path, SSM_model_name_path)
...
% HABITUATION CHANGE:
% Use the full recording length as one trial
options.Ltrial = size(X, 3);
