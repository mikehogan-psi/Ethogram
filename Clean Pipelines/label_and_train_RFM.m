...
output_folder = 'Z:\Mike\Data\Psilocybin Fear Conditioning\Cohort 4_06_05_25 (SC PAG Implanted Animals)\RFM Training Files\Darting';
...
video_list = dir(fullfile(master_video_path, 'camera*_mouse*_p1*'));
...
SSM_path = dir(fullfile(SSM_folder, '*p1*'));
...
save_name = [lower(behaviour), '_model_1'];
